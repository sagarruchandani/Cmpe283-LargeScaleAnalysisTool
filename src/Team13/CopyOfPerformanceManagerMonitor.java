...
public class CopyOfPerformanceManagerMonitor {
	File logFile;
	...
	public CopyOfPerformanceManagerMonitor() throws Exception {
...
//			e.printStackTrace();
			CopyOfPerformanceManagerMonitor pm = new CopyOfPerformanceManagerMonitor();
		}
		try {
			while(true){
			this.performanceManager();
			Thread.sleep(200000); // Wait 20 seconds and collect again
